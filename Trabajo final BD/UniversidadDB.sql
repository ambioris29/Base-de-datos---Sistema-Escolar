...
LEFT JOIN Estudiante E ON I.EstudianteID = E.EstudianteID;
...
JOIN Calificacion Ca ON I.InscripcionID = Ca.InscripcionID
GROUP BY 
    E.EstudianteID, E.Nombre, E.Apellido;
...
UPDATE Estudiante
SET Email = 'casemiro.nuevo@email.com'
WHERE Nombre = 'Casemiro' AND Apellido = 'Manrique';
